...
def ca_cert_endpoint():
    with open(CA_CERT_PATH, "r") as f:
        pem_data = f.read()
    return pem_data, 200, {"Content-Type": "text/plain; charset=utf-8"}
...
def sign_csr():
    ...
    try:
        ...
        return jsonify({"error": "Invalid CSR or signature", "details": str(e)}), 400
    ...
    return user_cert.public_bytes(serialization.Encoding.PEM).decode(), 200, {"Content-Type": "text/plain; charset=utf-8"}
